...
function displayHome() {
    ...
    <!-- MAIN CONTAINER WITH SIDEBAR AND CONTENT -->
        <div class="main-container">
            ...
            <!-- 3. MAIN CONTENT AREA -->
            <div class="content">
                <h1 class="game-title"><i class="fas fa-gamepad"></i> Welcome back, Adventurer!</h1>
                        	...
                        	<div class="slide-container">
                            	...
                            	<div class="slide">
                                	<div class="game-content">
                                    	...
                                    	<div class="game-image">
                                        	<img src="/static/resources/adadoun.png" alt="Game 1">
                                    	</div>
                                	</div>
                            	</div>
                            	...
                            	<div class="slide">
                                	<div class="game-content">
                                    	<h3>Game Title 2</h3>
                                    	<div class="game-image">
                                        	<img src="/static/resources/adadoun.png" alt="Game 2">
                                    	</div>
                                	</div>
                            	</div>
                            	...
                            	<div class="slide">
                                	<div class="game-content">
                                    	<h3>Game Title 3</h3>
                                    	<div class="game-image">
                                        	<img src="/static/resources/adadoun.png" alt="Game 3">
                                    	</div>
                                	</div>
                            	</div>
                            	...
                            	<div class="slide">
                                	<div class="game-content">
                                    	<h3>Game Title 4</h3>
                                    	<div class="game-image">
                                        	<img src="/static/resources/adadoun.png" alt="Game 4">
                                    	</div>
                                	</div>
                            	</div>
                        	</div>
...
function displayTopPlayers(leaderboardData) {
    ...
    validPlayers.forEach((player, index) => {
        ...
        const playerImage = '/static/resources/pic.png'; // Default placeholder
        ...
        playerCard.innerHTML = `
            ...
            <div class="player-avatar">
                <img src="${playerImage}" alt="Player ${index + 1}">
            </div>
            ...
            <div class="game-details">
                <div class="players-info">
                    <div class="player-left">
                        <img class="player-img" src="/static/resources/pic.png" alt="${game.winner.username}">
                    ...
                    <div class="player-right">
                        ...
                        <img class="player-img" src="/static/resources/pic.png" alt="${game.loser.username}">
                    </div>
                </div>
            </div>
        `;
...
//                         <!-- image container --> 
//                     	<div class="banner-image">
//                             <img src="/static/resources/adadoun.png" alt="Epic Quest Banner">
//                         </div>
//                 	</div>
//             	</div>
...
//         // Use the player's image if available, otherwise use placeholder
//         const playerImage = '/static/resources/adadoun.png'; // Default placeholder
...
//                 <div class="players-info">
//                     <div class="player-left">
//                         <img class="player-img" src="/static/resources/adadoun.png" alt="${game.winner.username}">
//                         <span class="player-name">${game.winner.username}</span>
//                     </div>
//                     <div class="score-container">
//                         <div class="game-result ${resultClass}">
...
//                     <div class="player-right">
//                         <span class="player-name">${game.loser.username}</span>
//                         <img class="player-img" src="/static/resources/adadoun.png" alt="${game.loser.username}">
//                     </div>
//                 </div>
//             </div>
//         `;
